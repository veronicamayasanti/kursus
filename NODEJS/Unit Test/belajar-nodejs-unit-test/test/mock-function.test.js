...
test("test mock return value", () => {
    ...
    expect(callback.mock.result[0].value).toBe(40);
    expect(callback.mock.result[1].value).toBe(80);
})
...
test("test mock implementation", () => {
    ...
    expect(callback.mock.result[0].value).toBe(60);
    expect(callback.mock.result[1].value).toBe(100);
